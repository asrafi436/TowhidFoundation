...
export const Footer = () => {
  ...
  return (
    <footer className="footer">
      <div className="footer__container min-h-80 bg-teal-600 w-full flex flex-col md:flex-row justify-between items-center gap-2">
        
        <div className="footer__logo p-4 flex flex-col justify-center items-center text-md font-semibold">
          <img src={footerImg} alt="logo" className="h-20 mr-4" />
          <br />
          <p>All our activities are only for the service of humanity.</p>
        </div>

        <div className="footer__social p-4 flex flex-col gap-2">
          <a
        ...
        <div className="p-4 flex flex-col">
          <h3 className="text-white font-bold py-2 px-4 rounded">
            Important Link:
          </h3>
